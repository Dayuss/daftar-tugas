...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?=base_url('dist/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')?>">
...
<script src="<?=base_url('dist/plugins/sweetalert2/sweetalert2.min.js')?>"></script>
